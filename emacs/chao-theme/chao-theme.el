;;; chao-theme.el --- A fruity color theme for Emacs.

;; Copyright (C) 2011-2015

;; Author: Kelvin Smith <oneKelvinSmith@gmail.com>
;; URL: http://github.com/oneKelvinSmith/chao-emacs
...
;; - http://www.chao.nl/blog/2006/07/15/textmate-color-theme/
;;
...
;;
;; K. Adam Christensen for his personal chao theme that addresses 256 colours.
;; - https://github.com/pope/personal/blob/master/etc/emacs.d/chao-theme.el
;;
...
(unless (>= emacs-major-version 24)
  (error "The chao theme requires Emacs 24 or later!"))

(deftheme chao "The Monokai colour theme")
...
(defcustom chao-distinct-fringe-background nil
  "Make the fringe background different from the normal background color.
Also affects 'linum-mode' background."
  :type 'boolean
  :group 'chao)

(defcustom chao-use-variable-pitch t
  "Use variable pitch face for some headings and titles."
  :type 'boolean
  :group 'chao)

(defcustom chao-high-contrast-mode-line nil
  "Make the active/inactive mode line stand out more."
  :type 'boolean
  :group 'chao)

(defcustom chao-height-minus-1 0.8
  "Font size -1."
  :type 'number
  :group 'chao)

(defcustom chao-height-plus-1 1.1
  "Font size +1."
  :type 'number
  :group 'chao)

(defcustom chao-height-plus-2 1.15
  "Font size +2."
  :type 'number
  :group 'chao)

(defcustom chao-height-plus-3 1.2
  "Font size +3."
  :type 'number
  :group 'chao)

(defcustom chao-height-plus-4 1.3
  "Font size +4."
  :type 'number
  :group 'chao)
...
(let* ((class                    '((class color) (min-colors 257)))
       ...
       (s-variable-pitch         (if chao-use-variable-pitch
                                     'default))
       (s-linum-bg              (if chao-distinct-fringe-background
                                     chao-hl chao-bg-line))
       (s-fringe-bg              (if chao-distinct-fringe-background
                                     chao-hl chao-bg))
       (s-mode-line-fg           (if chao-high-contrast-mode-line
                                     chao-bg chao-fg))
       (s-mode-line-bg           (if chao-high-contrast-mode-line
                                     chao-fg chao-hl-line))
       (s-mode-line-buffer-id-fg (if chao-high-contrast-mode-line
                                     'unspecified green))
       (s-mode-line-inactive-fg  (if chao-high-contrast-mode-line
                                     chao-fg chao-comments))
       (s-mode-line-inactive-bg  (if chao-high-contrast-mode-line
                                     chao-hl-line chao-bg))
       (s-mode-line-inactive-bc  (if chao-high-contrast-mode-line
                                     chao-fg chao-hl-line))
       ...
       (terminal-red                      "#FF1493")
       (terminal-magenta                  "#FF005F")
       (terminal-violet                   "#AF87FF")
       (terminal-blue                     "#5FD7FF")
       (terminal-cyan                     "#5FFFFF")
       (terminal-cyan3                    "#00CDCD")
       (terminal-green                    "#00D700")
       ...
       (terminal-red-l                    "#D7005F")
       (terminal-magenta-d                "#FF005F")
       ...
       ;; Adaptive colors
       (terminal-chao-fg               "#F8F8F5")
       (terminal-chao-bg               "#1C1C1C")
       (terminal-chao-bg-line          "#303030")
       (terminal-chao-hl-line          "#212121")
       (terminal-chao-hl               "#303030")
       (terminal-chao-emph             "#FFFAFA")
       (terminal-chao-comments         "#bcbcbc")
       ;; Adaptive higher/lower contrast accented colors
       (terminal-chao-fg-hc            "#171A0B")
       (terminal-chao-fg-lc            "#141414")
       ;; High contrast colors
       ...
       ;; customize based face properties
       (terminal-s-variable-pitch         (if chao-use-variable-pitch
                                              'default))
       (terminal-s-linum-bg               (if chao-distinct-fringe-background
                                              terminal-chao-hl terminal-chao-bg-line))
       (terminal-s-fringe-bg              (if chao-distinct-fringe-background
                                              terminal-chao-hl terminal-chao-bg))
       (terminal-s-mode-line-fg           (if chao-high-contrast-mode-line
                                              terminal-chao-bg terminal-chao-fg))
       (terminal-s-mode-line-bg           (if chao-high-contrast-mode-line
                                              terminal-chao-fg terminal-chao-hl-line))
       (terminal-s-mode-line-buffer-id-fg (if chao-high-contrast-mode-line
                                              'unspecified terminal-green))
       (terminal-s-mode-line-inactive-fg  (if chao-high-contrast-mode-line
                                              terminal-chao-fg terminal-chao-comments))
       (terminal-s-mode-line-inactive-bg  (if chao-high-contrast-mode-line
                                              terminal-chao-hl-line terminal-chao-bg))
       (terminal-s-mode-line-inactive-bc  (if chao-high-contrast-mode-line
                                              terminal-chao-fg terminal-chao-hl-line)))
  ...
  (custom-theme-set-faces
   ...
   ;; basic coloring
   `(default
      ((,class (:foreground ,chao-fg
                            :background ,chao-bg))
       (,terminal-class (:foreground ,terminal-chao-fg
                                     :background ,terminal-chao-bg))))

   `(shadow
     ((,class (:foreground ,chao-comments))
      (,terminal-class (:foreground ,terminal-chao-comments))))

   `(match
     ((,class (:background ,chao-hl
                           :foreground ,chao-emph
                           :weight bold))
      (,terminal-class (:background ,terminal-chao-hl
                                    :foreground ,terminal-chao-emph
                                    :weight bold))))

   `(cursor
     ((,class (:foreground ,chao-bg
                           :background ,chao-fg
                           :inverse-video t))
      (,terminal-class (:foreground ,terminal-chao-bg
                                    :background ,terminal-chao-fg
                                    :inverse-video t))))
   ...
   `(cua-rectangle-noselect
     ((,class (:inherit region
                        :background ,chao-hl
                        :foreground ,chao-comments))
      (,terminal-class (:inherit region
                                 :background ,terminal-chao-hl
                                 :foreground ,terminal-chao-comments))))
   ...
   `(ecb-tree-guide-line-face
     ((,class (:inherit ecb-default-general-face
                        ...
                        :height 1.0))
      (,terminal-class (:inherit ecb-default-general-face
                                 :foreground ,terminal-chao-hl
                                 :height 1.0))))

   ;; ee
   `(ee-bookmarked
     ((,class (:foreground ,chao-emph))
      (,terminal-class (:foreground ,terminal-chao-emph))))
   ...
   `(vertical-border
     ((,class (:foreground ,chao-hl))
      (,terminal-class (:foreground ,terminal-chao-hl))))
   ...
   `(font-latex-italic-face
     ((,class (:inherit italic :foreground ,chao-emph))
      (,terminal-class (:inherit italic :foreground ,terminal-chao-emph))))
   ...
   `(font-latex-subscript-face
     ((,class (:height ,chao-height-minus-1))
      (,terminal-class (:height ,chao-height-minus-1))))
   ...
   `(company-scrollbar-fg
     ((,class (:background ,chao-comments))
      (,terminal-class (:background ,terminal-chao-comments))))
   ...
   `(diff-header
     ((,class (:background ,chao-bg))
      (,terminal-class (:background ,terminal-chao-bg))))
   ...
   `(ediff-even-diff-A
     ((,class (:background ,chao-comments
                           :foreground ,chao-fg-lc ))
      (,terminal-class (:background ,terminal-chao-comments
                                    :foreground ,terminal-chao-fg-lc ))))

   `(ediff-odd-diff-A
     ((,class (:background ,chao-comments
                           :foreground ,chao-fg-hc ))
      (,terminal-class (:background ,terminal-chao-comments
                                    :foreground ,terminal-chao-fg-hc ))))
   ...
   `(gnus-x-face
     ((,class (:background ,chao-fg
                           :foreground ,chao-bg))
      (,terminal-class (:background ,terminal-chao-fg
                                    :foreground ,terminal-chao-bg))))
   ...
   ;; hl-line-mode
   `(hl-line
     ((,class (:background ,chao-hl-line))
      (,terminal-class (:background ,terminal-chao-hl-line))))
   ...
   `(neo-vc-unlocked-changes-face
     ((,class (:foreground ,red
                           :background ,chao-comments))
      (,terminal-class (:foreground ,terminal-red
                                    :background ,terminal-chao-comments))))
   ...
   `(org-agenda-structure
     ((,class (:foreground ,chao-emph
                           ...
                           :height ,chao-height-plus-1
                           :underline nil
                           :box (:line-width 2 :color ,chao-bg)))
      (,terminal-class (:foreground ,terminal-chao-emph
                                    :background ,terminal-chao-hl
                                    :weight bold
                                    :slant normal
                                    ...
                                    :height ,chao-height-plus-1
                                    :underline nil
                                    :box (:line-width 2 :color ,terminal-chao-bg)))))
   ...
   `(org-agenda-date
     ((,class (:foreground ,chao-comments
      ...
      (,terminal-class (:foreground ,terminal-chao-comments
                                    ...
                                    :slant normal
                                    :height 1.0
                                    :box (:line-width 2 :color ,terminal-chao-bg)))) t)
   ...
   ;; parenface
   `(paren-face
     ((,terminal-class (:foreground ,chao-comments))))
   ...
   `(popup-scroll-bar-foreground-face
     ((,class (:background ,chao-emph))
      (,terminal-class (:background ,terminal-chao-emph))))
   ...
   `(zencoding-preview-input
     ((,class (:background ,chao-hl
                           :box ,chao-emph))
      (,terminal-class (:background ,terminal-chao-hl
                                    :box ,terminal-chao-emph)))))

  (custom-theme-set-variables
   'chao
   `(ansi-color-names-vector [,chao-bg ,red ,green ,yellow
                                          ,blue ,magenta ,cyan ,chao-fg])

   ;; compilation
   `(compilation-message-face 'default)

   ;; fill-column-indicator
   `(fci-rule-color ,chao-hl)
   ...
   `(highlight-tail-colors
     '((,chao-hl . 0)(,green-lc . 20)(,cyan-lc . 30)(,blue-lc . 50)
       (,yellow-lc . 60)(,orange-lc . 70)(,magenta-lc . 85)(,chao-hl . 100)))

   ;; pos-tip
   `(pos-tip-foreground-color ,chao-bg)
